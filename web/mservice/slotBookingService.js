...
function slotBooking(req, res) {
    ...
    postData.timeSlot = new Date(postData.bookingDate.getFullYear(),postData.bookingDate.getMonth(),postData.bookingDate.getDate(),postData.bookingTime.getHours()+8, postData.bookingTime.getMinutes(), postData.bookingTime.getSeconds());
