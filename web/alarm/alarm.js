...
function alarmCollide(){
    var s4Id=1;
    var sql="select u.nick,u.phone,c.license,c.brand as brandCode,c.series as seriesCode,cd.brand,cd.series,r.remindType,r.remindStatus,r.createTime " +
        "from t_remind r " +
    ...
    dao.findBySql(sql,[s4Id,1],function(rows){
        console.log(rows);
    });
}
alarmCollide();